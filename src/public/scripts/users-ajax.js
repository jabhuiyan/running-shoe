        ...
        html += `
              <tr>
                ...
                <td class="admin-visible">
                  <a href="/ui/users/edit?email=${users[i].email}"><button class="btn btn-secondary btn-sm">Edit</button></a>
...
function getAuthenticatedUser() {
  ...
  $.ajax({
    type: "get",
    url: "/api/users/profile?secret_token=" + token,
    dataType: "json",
    success: function (response) {
      ...
      $("#user_edit").attr(
        "href",
        "/ui/users/edit?email=" + response.user.email
      );
